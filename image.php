				...
				<header class="entry-header">
					...
					<div class="entry-meta">
						<?php
							...
							printf( __( 'Published <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s">%4$s &times; %5$s</a> in <a href="%6$s" rel="gallery">%7$s</a>', 'lunarlove' ),
				...
				<div class="entry-content">
					<div class="entry-attachment">
						<div class="attachment">
							<?php lunarlove_the_attached_image(); ?>
						</div><!-- .attachment -->
