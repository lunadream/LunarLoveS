...
function ajax_comment_scripts(){
    wp_enqueue_style( 'ajax-comment', get_template_directory_uri() . '/inc/ajax-comment.css', array(), '20150225' );
    wp_enqueue_script( 'ajax-comment', get_template_directory_uri() . '/inc/ajax-comment.js', array( 'jquery' ), '20150225', true );
        ...
        <article class="comment-body clear">
            <footer class="comment-meta">
                ...
                <div class="comment-metadata">
                    ...
                    <span class="attime">在 </span><time class="comment-time" datetime="<?php echo get_comment_date('Y-M-d G:i'); ?>"><?php echo get_comment_date('Y-M-d G:i'); ?></time><span class="says"> 说:</span>
                </div>
            </footer>
